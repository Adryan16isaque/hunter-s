...
**Hunter-S** é um simulador de gerenciamento de uma Guilda de Caçadores, desenvolvido inteiramente em **TypeScript**. O projeto nasce de uma missão prática com temática de RPG e vai além: dungeon e criação de personagem **dinâmicos**, configuráveis em tempo de execução.
...
- **🗡️ Dungeon dinâmica** — dificuldade variável definida na execução
...
minhaGuilda.registrarCaçador(cazador);
